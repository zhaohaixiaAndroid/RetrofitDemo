...
import com.zhx.app.retrofitdemo.IpResult;
...
public class RetrofitClient {
    ...
    private static OkHttpClient.Builder httpClient =
            new OkHttpClient.Builder()
                    .addNetworkInterceptor(
                            myLogInterceptor().setLevel(HttpLoggingInterceptor.Level.HEADERS))
   ...
   private RetrofitClient() {
    ...
    private RetrofitClient(Context context, String url, Map<String, String> headers) {
        ...
        okHttpClient = new OkHttpClient.Builder()
                .addNetworkInterceptor(
                       myLogInterceptor().setLevel(HttpLoggingInterceptor.Level.BODY))
   ...
   /**
    ...
    private static HttpLoggingInterceptor myLogInterceptor(){
